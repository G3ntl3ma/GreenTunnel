...
Options:
  --ip                   IP address to bind proxy server for --system-proxy=true    [string]  [default: "127.0.0.1"]
  --port                 Port to bind proxy server for --system-proxy=true          [number]  [default: 8000]
  ...
  --tls-record-frag...   Enable TLS record fragmentation for --dns-type=https   [boolean] [default: false]
